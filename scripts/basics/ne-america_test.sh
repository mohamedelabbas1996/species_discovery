...
python $CURDIR/scripts/eval_trained.py \
    --config configs/datasets/ami/ne-america.yml \
      configs/datasets/ami/ne-america_ood_test.yml \
    ...
    --network.checkpoint /network/scratch/y/yuyan.chen/ood_benchmark/ami/classifier/resnet50/5749459/checkpoints/model_best.pth \
