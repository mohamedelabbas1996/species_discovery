...
sbatch scripts/clustering/ami_trap/resnet50_dbscan.sh 30
sbatch scripts/clustering/ami_trap/resnet50_dbscan.sh 40
# sbatch scripts/clustering/ami_trap/resnet50_dbscan.sh 50
